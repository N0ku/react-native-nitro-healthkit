...
/**
 * Represents an instance of `CategoryDataPoint`, backed by a C++ struct.
 */
public typealias CategoryDataPoint = margelo.nitro.healthkit.CategoryDataPoint

public extension CategoryDataPoint {
  private typealias bridge = margelo.nitro.healthkit.bridge.swift

  /**
   * Create a new instance of `CategoryDataPoint`.
   */
  init(value: Double, startDate: Date, endDate: Date, metadata: Dictionary<String, String>?) {
    self.init(value, startDate.toCpp(), endDate.toCpp(), { () -> bridge.std__optional_std__unordered_map_std__string__std__string__ in
